...
Yhat3ANNVinalhaven=outputs(501:800)';

[R23ANN,RMSE3ANN]=rsquare(Ytest,Yhat3ANNVinalhaven);
MAPE3ANN = mean(abs(Yhat3ANNVinalhaven-Ytest)./Ytest);

figure
plot(Ytest,'LineWidth',3);
hold on
plot(Yhat3ANNVinalhaven,'--r','LineWidth',3);
