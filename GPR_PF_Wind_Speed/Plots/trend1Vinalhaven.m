...
hold on
plot( x(1:3:300),Yhat1ARIMAVinalhaven(1:3:300), 'dg');
xlabel('Sample');
ylabel('Wind Speed (m/s)');
% title('One-step-ahead Wind Speed Prediction in Vinalhaven');
legend('Actual Speed','Predicted Speed (ARIMA)','Location','South');
hold off
subplot(5,1,2);
plot(YtestVinalhaven); 
hold on
plot( x(1:3:300),Yhat1ANNVinalhaven(1:3:300),'pc');
xlabel('Sample');
ylabel('Wind Speed (m/s)');
...
plot(YtestVinalhaven); 
hold on
plot( x(1:3:300),Yhat1SVRVinalhaven(1:3:300),'o','Color',[1 0.5 0.2]);
xlabel('Sample');
ylabel('Wind Speed (m/s)');
...
plot(YtestVinalhaven); 
hold on
plot( x(1:3:300),Yhat1GPRVinalhaven(1:3:300),'+k');
xlabel('Sample');
ylabel('Wind Speed (m/s)');
...
plot(YtestVinalhaven); 
hold on
plot( x(1:3:300),Yhat1GPRPFVinalhaven(1:3:300),'*r');
xlabel('Sample');
ylabel('Wind Speed (m/s)');
